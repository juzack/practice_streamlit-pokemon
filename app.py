...
print("page reloaded")
st.set_page_config(
    page_title="Streamlit Learnin-ing.",
...
st.markdown("""
    <style>
        ...
        [data-testid="styledFullScreanButton"]
            visibility: hidden;
        }
    </style>
...
st.subheader("안녕하세요. 하나씩 추가해주세요.")
st.markdown("**수업**을 하나씩 추가")
